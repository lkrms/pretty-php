 ...
 * @method Formatter with(("RelaxAlignmentCriteria"|"NewlineBeforeFnDoubleArrow"|"AlignChainAfterNewline") $property, bool $value) Get an instance with the given setting enabled or disabled
