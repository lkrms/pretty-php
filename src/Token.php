...
final class Token extends GenericToken implements HasTokenNames, JsonSerializable
{
     ...
     * @phpstan-var array{self,self|null,self|null,self,bool,TokenCollection,int,TokenCollection,array{TokenCollection,TokenCollection,TokenCollection,TokenCollection,TokenCollection},self,self,self,self,int,TokenCollection,int,self,string,Closure[]}
     */
    public array $Data;
